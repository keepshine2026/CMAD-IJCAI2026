...
try:
    from CMAD.llm import VisualLLMRegistry  # type: ignore
except Exception:
    VisualLLMRegistry = None  # type: ignore

from CMAD.utils.log import logger
...
class IMGReader(Reader):
    def parse(self, file_path: Path, task: str = "Describe this image as detail as possible." ) -> str:
        ...
        if VisualLLMRegistry is None:
            raise ImportError("VisualLLMRegistry is not available in this codebase.")
